...
contains
    ...
    subroutine get_atmospheric_properties(h, rho, T, p)
        ...
        integer :: i
        real(8), parameter :: hb(8) = (/0.0D0, 11000.0D0, 20000.0D0, 32000.0D0, 47000.0D0, 51000.0D0, 71000.0D0, 84852.0D0/)
        real(8), parameter :: Tb(8) = (/288.15D0, 216.65D0, 216.65D0, 228.65D0, 270.65D0, 270.65D0, 214.65D0, 186.946D0/)
        real(8), parameter :: Pb(8) = (/101325.0D0, 22632.06D0, 5474.889D0, 868.0187D0, 110.9063D0, 66.93887D0, 3.956420D0, 0.3734D0/)
        real(8), parameter :: Lb(8) = (/-0.0065D0, 0.0D0, 0.0010D0, 0.0028D0, 0.0D0, -0.0028D0, -0.0020D0, 0.0D0/)
